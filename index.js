...
function draw_highlight(ii,jj) { let context = Module.canvas.getContext('2d'); let width = Module.canvas.width ; let sqsize = width/8; context.beginPath(); context.rect(ii*sqsize,jj*sqsize,sqsize,sqsize); context.stroke(); }
